...
function OrderConfirm(){
    ...
    useEffect(()=>{
        Axios.get("https://rides-server.onrender.com/bikes/orderedProduct/"+productid)
        .then((res)=>{
    ...
    useEffect(()=>{
        Axios.get("https://rides-server.onrender.com/bikes/account/"+id)
        .then((res)=>{
    ...
    const handleSubmit = () => {
        ...
        Axios.post("https://rides-server.onrender.com/bikes/addtoorder",{userid,productid})
        .then((res)=>{
