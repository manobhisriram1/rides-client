...
function UserDetails(){
    ...
    useEffect(()=>{
        Axios.get("https://rides-server.onrender.com/bikes/admin-account/"+id)
        .then((res)=>{
    ...
    useEffect(()=>{
        Axios.get("https://rides-server.onrender.com/bikes/")
        .then((res)=>{
    ...
    const handleDelete = (e) => {
        ...
        Axios.delete("https://rides-server.onrender.com/bikes/delete-user/"+id)
        .then((res)=>{
            if(res.status===200){
